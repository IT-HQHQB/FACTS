...
router.post('/case/:caseId', authenticateToken, authorizeCaseAccess, async (req, res) => {
  try {
    ...
    if (existingForms[0].length > 0) {
      ...
      // Create new form - use column list to generate VALUES placeholders so count always matches
      const insertColumns = [
        'case_id', 'applicant_name', 'applicant_jamiat', 'applicant_jamaat', 'applicant_age',
        'applicant_contact_number', 'applicant_case_id', 'applicant_its', 'applicant_photo',
        'counsellor_name', 'counsellor_jamiat', 'counsellor_jamaat', 'counsellor_age',
        'counsellor_contact_number', 'counsellor_its', 'counsellor_certified', 'counsellor_photo',
        'current_personal_income', 'current_family_income', 'earning_family_members', 'dependents',
        'asset_house', 'asset_shop', 'asset_gold', 'asset_machinery', 'asset_stock',
        'liability_qardan', 'liability_den', 'liability_others',
        'business_name', 'industry_segment', 'present_occupation',
        'requested_enayat', 'requested_qardan', 'requested_total',
        'recommended_enayat', 'recommended_qardan', 'recommended_total',
        'applicant_projected_income_after_1_year', 'applicant_projected_income_after_2_years',
        'applicant_projected_income_after_3_years', 'applicant_projected_income_after_4_years',
        'applicant_projected_income_after_5_years',
        'family_projected_income_after_1_year', 'family_projected_income_after_2_years',
        'family_projected_income_after_3_years', 'family_projected_income_after_4_years',
        'family_projected_income_after_5_years',
        'proposed_upliftment_plan', 'non_financial_assistance', 'welfare_department_comments',
        'approved_enayat', 'approved_qardan', 'approved_qh_months',
        'welfare_department_its', 'welfare_department_name', 'welfare_department_signature_type',
        'welfare_department_signature_file_path', 'welfare_department_signature_drawing_data',
        'welfare_department_date',
        'zonal_incharge_its', 'zonal_incharge_name', 'zonal_incharge_signature_type',
        'zonal_incharge_signature_file_path', 'zonal_incharge_signature_drawing_data',
        'zonal_incharge_date',
        'operations_head_its', 'operations_head_name', 'operations_head_signature_type',
        'operations_head_signature_file_path', 'operations_head_signature_drawing_data',
        'operations_head_date'
      ];
      const insertValues = [
        caseId,
      ...
      const [result] = await pool.execute(
        `INSERT INTO cover_letter_forms (${insertColumns.join(', ')}) VALUES (${placeholders})`,
        insertValues
      );
